...
from Define import log_path, shared_log_path
...
def get_logger(service: LogService) -> logging.Logger:
    ...
    - shared_log_path (dùng cho Discord)
    - file log riêng của service (syslog.log)
    Định dạng: YYYY-mm-dd HH:MM:SS | LEVEL | SERVICE | message
    """
    ...
    # Handler shared log (ghi mọi service)
